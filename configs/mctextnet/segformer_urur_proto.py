...
clip_text = "/mnt/data/nas/gyl/RS_Code/mmseg_exp/Code/cliptxt_h14_t23_54.pt"
...
model = dict(
    ...
    backbone=dict(
        ...
        num_heads=[1, 2, 5, 8],
        num_layers=[3, 6, 40, 3]),
    decode_head=dict(type='Proto_SegformerHead', k=10, momentum=0.999, text_path=clip_text, in_channels=[64, 128, 320, 512], num_classes=8),
