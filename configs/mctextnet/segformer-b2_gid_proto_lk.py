...
record_path = '/home/rsr/gyl/RS_DATASET/boxes_jsonl/gid_record.jsonl'
boxes_path = '/home/rsr/gyl/RS_DATASET/boxes_jsonl/gid_boxes.jsonl'
...
model = dict(
    ...
    backbone=dict(
        ...
        num_heads=[1, 2, 5, 8],
        num_layers=[3, 4, 6, 3]),
    decode_head=dict(type='Proto_SegformerHead', k=10, momentum=0.999, text_path=clip_text, iflk=True, in_channels=[64, 128, 320, 512], num_classes=6),
...
val_dataloader = dict(batch_size=2, num_workers=2, dataset=dict(pipeline=test_pipeline))
