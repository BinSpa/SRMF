...
clip_model_ckpt = "/mnt/data/nas/gyl/RS_Code/GeoRSCLIP/ckpt/RS5M_ViT-B-32.pt"
...
train_pipeline = [
    ...
    dict(type='RandomFlip', prob=0.8, direction=['horizontal', 'vertical']),
    dict(type='MultiLevelCrop', crop_size=crop_size, cat_max_ratio=0.75, level_list=[1,2,3,4]),
    dict(type='Image_Level_Text', level_list=[1,2,3,4], ckpt_path=clip_model_ckpt, class_names=["background", "building", "farmland", "greenhouse", "woodland", "bareland", "water", "road"]),
    dict(type='PackSegMultiInputs')
]
