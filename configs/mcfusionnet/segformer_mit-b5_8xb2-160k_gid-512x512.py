...
model = dict(
    ...
    auxiliary_head=dict(
        ...
        loss_decode=dict(
            type='CrossEntropyLoss', use_sigmoid=False, loss_weight=1.0)),
    test_cfg = dict(mode='mc_slide',crop_size=(512, 512),stride=(341, 341),levels=[1,2,4,6]))
...
train_pipeline = [
    ...
    dict(type='MultiLevelCrop', crop_size=crop_size, cat_max_ratio=0.75, level_list=[1,2,4,6], withlocal=True),
